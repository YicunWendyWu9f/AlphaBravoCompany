...
description: "Instructions on deploying Longhorn, Monitoring and Logging on RKE2."
slug: "single-node-rke2-pt2"
date: 2021-12-01T13:00:00Z
draft: false
featuredImage: /assets/single-node-rke2-pt2-full.png
featuredImagePreview: /assets/single-node-rke2-pt2-full.png
lightgallery: true
...
In the first [blog](https://blog.alphabravo.io/posts/2021/single-node-rke2-pt1/) post of this series, we deployed a single node RKE2 deployment and Rancher UI or a cheap Hetzner server. 
...
- Rancher Monitoring
- Rancher Logging
- Elasticsearch and Kibana to store logs
